/*
	正则表达式
		...
		How?
			...
			🚗位置匹配 (每个位置都可以理解为一个空字符串, 字符之间的位置)
				^  ->  匹配开头
				$  ->  匹配结尾

			🌲 分支匹配
				/123|234/g  ->  匹配 123 或 234
...
// 🚗位置匹配
const str8888 = '123jaosjsa123dlkc123jaosjsa123'

const reg288 = /^123/g // ^ 匹配开头的 123
const res288 = str8888.match(reg288)
console.log('匹配开头的 123 :', res288)


const str9999 = `123jaosjsa123dlkc123jaosjsa123
djksd123`
const reg299 = /123$/g // $ 匹配一个结尾的 123
const res299 = str9999.match(reg299)
console.log('匹配结尾的 123 :', res299)



const str7777 = `123jaosjsa123dlkc123jaosjsa123
djksd123
xzpioqm123
`

const reg7777 = /123$/gm // 加了个 m 表示匹配多个结尾的 123
const res7777 = str7777.match(reg7777)
console.log('匹配结尾的 123 :', res7777)




// 🌲分支匹配
const str1111 = '123ioapsa234saopkpkop123cokpcx234dlw'
const reg1111 = /123|234/g
const res1111 = str1111.match(reg1111)
console.log('分支匹配:', res1111)


// 比如给头尾都加个 #
let res998 = 'hello'.replace(/^|$/g, '#') // ^ $ 表示头尾, 每个位置都可以理解为有个空字符串
console.log('头尾添加 # 号:', res998)
